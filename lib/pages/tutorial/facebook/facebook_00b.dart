import 'package:ecolecua/pages/tutorial/facebook/facebook_01_video.dart';
...
class Facebook00bPage extends StatelessWidget {
  final AppConfigService appConfigService;

  const Facebook00bPage({Key key, this.appConfigService}) : super(key: key);
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Facebook01VideoPage(appConfigService)),
                    );
                  },
                  child: Text('Sí',
                      style:
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Facebook01Page(appConfigService: appConfigService)),
                    );
                  },
                  elevation: 20.0,
                )
