...
class Youtube01VideoPage extends StatefulWidget {
  final AppConfigService appConfigService;

  const Youtube01VideoPage(this.appConfigService);

  @override
  _Youtube01VideoState createState() => new _Youtube01VideoState();
}
  ...
  return MaterialButton(
      ...
      onPressed: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => Youtube01Page(appConfigService: appConfigService)));
      },
